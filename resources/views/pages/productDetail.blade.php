        ...
        <div class="flex flex-col mt-10">
            ...
            <div class="mb-6">
                ...
                <div class="flex gap-3">
                    ...
                    <button type="button" class="size-btn w-10 h-10 rounded-md border border-gray-300 text-sm font-medium text-gray-700 hover:border-gray-900 transition" data-size="XL">XL</button>
                </div>
            </div>
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('checkout') }}" class="block w-full py-3 px-6 bg-gray-900 text-white text-center font-semibold rounded-lg hover:bg-gray-800 transition">
                    BUY NOW
                </a>
            </div>
        </div>
